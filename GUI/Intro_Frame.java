...
public class Intro_Frame extends JFrame implements ActionListener {
	...
	public Intro_Frame () {
		...
		ImagePanel introTitle = new ImagePanel(new ImageIcon(
								"C:\\SRC\\JAVA\\Test1127\\Image\\Introtitle.png").getImage());
		...
		ImagePanel introImage = new ImagePanel(new ImageIcon(
				"C:\\SRC\\JAVA\\Test1127\\Image\\intro(315_250).jpg").getImage());
		jp3.add(introImage);
